...
- (void)button1Click{
	//[self.view OYQ_makeToast:@"123阿大大一奥苏姑嫂发"];
	[self.view OYQ_makeToast:@"123阿素雅US一大" title:@"标题" duration:2.0f toastPosition:OYQToastPositionDefault image:[UIImage imageNamed:@"icon64_wx_logo"] imagePosition:OYQImagePositionDefault];
}
